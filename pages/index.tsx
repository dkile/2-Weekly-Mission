		...
		<Layout>
			<main>
				<ServiceIntroCard
					...
					thumbnail={`${assetRoutes.image}/content-img1`}
				/>
				<ServiceIntroCard
					title={
						<>
					...
					thumbnail={`${assetRoutes.image}/content-img2`}
				/>
				<ServiceIntroCard
					title={
						<>
					...
					thumbnail={`${assetRoutes.image}/content-img3`}
				/>
				<ServiceIntroCard
					title={
						<>
					...
					thumbnail={`${assetRoutes.image}/content-img4`}
				/>
			</main>
		</Layout>
	);
